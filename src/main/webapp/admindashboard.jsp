...
<head>
<meta charset="UTF-8">
<title>Admin Dashboard | ChefConnect</title>
<link
...
<body>
	...
	<div class="sidebar">
		<h2>ChefConnect</h2>
		<a href="#" class="active">🏠 Dashboard</a> <a href="managechefs.jsp">👨‍🍳
			Manage Chefs</a> <a href="chefviewrequests.jsp">🧑‍💼 Customers</a> <a href="show_request.jsp">📅 Request</a> <a href="#">⚙️ Settings</a> <a
			...
			<table>
				...
				try {
					...
					PreparedStatement ps = con.prepareStatement(
						    "SELECT uid, uname, uemail, ucontact, status AS chef_status FROM chef_user"
						);
